...
// Bloqueo de seguridad: si no hay sesión iniciada, expulsar al login raíz
...
// 4. Consultar los datos frescos para pintar las tablas de forma dinámica
...
<head>
    ...
    <style>
        ...
        .alert-ok { color: #155724; background-color: #d4edda; padding: 10px; border-radius: 4px; margin-bottom: 15px; }
        .alert-bad { color: #721c24; background-color: #f8d7da; padding: 10px; border-radius: 4px; margin-bottom: 15px; }
    </style>
</head>
<body>
        ...
        <div class="content" style="flex: 1; padding: 20px;">
            ...
            <div class="catalogos-container">
                ...
                <div class="catalogo-seccion">
                    ...
                    <p style="font-size:13px; color:#666;">Ej. Laptops, Sensores, Herramientas, Pantallas.</p>
                    ...
                    <table class="tabla-datos">
                        ...
                        <tbody>
                            <?php if ($lista_categorias && $lista_categorias->num_rows > 0): ?>
                                <?php while($row = $lista_categorias->fetch_assoc()): ?>
                                    <tr>
                                ...
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr><td colspan="2" style="color: #999; text-align: center;">No hay categorías registradas.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="catalogo-seccion">
                    ...
                    <p style="font-size:13px; color:#666;">Ej. Almacén A, Laboratorio de Cómputo, Estante 3.</p>
                    ...
                    <table class="tabla-datos">
                        ...
                        <tbody>
                            <?php if ($lista_ubicaciones && $lista_ubicaciones->num_rows > 0): ?>
                                <?php while($row = $lista_ubicaciones->fetch_assoc()): ?>
                                    <tr>
                                        <td>#<?php echo $row['id']; ?></td>
                                        <td><strong><?php echo htmlspecialchars($row['nombre']); ?></strong></td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr><td colspan="2" style="color: #999; text-align: center;">No hay ubicaciones registradas.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
